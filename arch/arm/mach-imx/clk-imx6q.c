...
static void __init imx6q_clocks_init(struct device_node *ccm_node)
{
	...
	*/
	...
	/* Output 100MHz to the FPGA */
	imx_clk_set_parent(clk[IMX6QDL_CLK_LVDS2_SEL], clk[IMX6QDL_CLK_SATA_REF]);
	...
	printk(KERN_DEBUG "IMX6QDL_CLK_IPU1: %u\n", clk_get_rate(clk[IMX6QDL_CLK_IPU1]));
