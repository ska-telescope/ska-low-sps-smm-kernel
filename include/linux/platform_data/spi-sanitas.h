...
#define INVENTAMI_SPI_FLAGS_STATIC_CS 0x00
#define INVENTAMI_SPI_FLAGS_STATIC_CS_LEN 1
#define INVENTAMI_SPI_FLAGS_STATIC_CS_OFF 0

#define INVENTAMI_SPI_CHIP_SELECTS_ADD 0x02
#define INVENTAMI_SPI_CHIP_SELECTS_LEN 3
#define INVENTAMI_SPI_CHIP_SELECTS_OFF 0

#define INVENTAMI_SPI_CMD_TX_ADD 0x04
#define INVENTAMI_SPI_CMD_TX_LEN 9
#define INVENTAMI_SPI_CMD_TX_OFF 0

#define INVENTAMI_SPI_CMD_RX_ADD 0x06
#define INVENTAMI_SPI_CMD_RX_LEN 9
#define INVENTAMI_SPI_CMD_RX_OFF 0

#define INVENTAMI_SPI_TXFIFO_SIZE_ADD 0x08
#define INVENTAMI_SPI_TXFIFO_SIZE_LEN 16
#define INVENTAMI_SPI_TXFIFO_SIZE_OFF 0

#define INVENTAMI_SPI_RXFIFO_SIZE_ADD 0x0A
#define INVENTAMI_SPI_RXFIFO_SIZE_LEN 16
#define INVENTAMI_SPI_RXFIFO_SIZE_OFF 0

#define INVENTAMI_SPI_FIFO_PTR_ADD 0x0C
#define INVENTAMI_SPI_FIFO_PTR_LEN 32
